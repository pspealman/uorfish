...
v1.0 (ejovalip)
___ public beta
___ added p_site_analysis

# future versions:
___ maximize fit argument
#
    ...
    if file_path.is_file():
        ...
        if args.configure_run:
            ...
            if args.validated_uorfs_filename:
                ...
                resource_dict['validated_uorfs_filename'] = 'demo/validated_uorfs.csv'
...
def make_psite_bedgraph(sample_read_object, runmode,  norm_multiplier):
    ...
    for sign in psite_dict:
        ...
        outfile_name = ('{runname}_{data_type}_{runmode}_{textsign}.bedgraph').format(
            runname = runname,
            data_type = data_type,
            runmode = runmode,
            textsign = textsign)
...
#     rpf_object_name = resources_object['rpf_object']
